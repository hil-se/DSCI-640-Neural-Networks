...
Programming Assignment 1 is 28% of your final grade, and PA1-4 is 25% of that. It will be traded out of 7 points as follows:
...
5. (1 points) Create a data/ConvertMushroom.java class that will take the raw mushroom data in agaricus-lepiota.data and convert it to the one-hot encoding found in agaricus-lepiota.txt (you can use my provided data set to make sure you have implemented this correctly).

6. (1 point) Nesterov momentum in PA14GradientDescent.java. Save a screenshot of your output [screenshot_nesterov.png]().
```
java PA14GradientDescent mushroom minibatch 10 softmax 10 0.1 0.01 0.95 10 10
```
Will run gradient descent on the mushroom data set with minibatch gradient with a batch size of 10 for 10 epochs, initializing node bias to 0.1, using a learning rate of 0.01, a mu of 0.95, and a network with two layers each with 10 nodes.

Expected output:
<img width="1003" height="495" alt="image" src="https://github.com/user-attachments/assets/7ff8778e-49cd-4b49-a9ea-2d7fd010f331" />

7. (0.5 points) Implement RMSprop. Save a screenshot of your output [screenshot_rmsprop.png]().

<img width="935" height="533" alt="image" src="https://github.com/user-attachments/assets/6b34be0d-5115-42ab-a44c-968522db2445" />

8. (0.5 points) Implement Adam. Save a screenshot of your output [screenshot_adam.png]().

<img width="921" height="534" alt="image" src="https://github.com/user-attachments/assets/3c0c65b5-8cc5-43f8-93e1-8f0b2d2f47c5" />
...
loss function can be: 'l1_norm', 'l2_norm', 'svm' or 'softmax'. note that you need to use l1 or l2 norm for the or, and or xor data, and svm or softmax for the iris or mushroom data
