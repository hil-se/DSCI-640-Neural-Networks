...
5. (1 point) Nesterov momentum in PA14GradientDescent.java. Save a screenshot of your output [screenshot_nesterov.png]().
```
...
6. (1 points) Create a data/ConvertMushroom.java class that will take the raw mushroom data in agaricus-lepiota.data and convert it to the one-hot encoding found in agaricus-lepiota.txt (you can use my provided data set to make sure you have implemented this correctly).
