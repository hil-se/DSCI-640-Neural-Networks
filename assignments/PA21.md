...
Programming Assignment 2 is 28% of your final grade, and Part 1 is 25% of that.  This will be graded out of 7 points.
...
2. (4 points) Complete the RecurrentNeuralNetwork.forwardPass method. This will include completing a few submethods (e.g., RecurrentNode.applyTanh and RecurrentNode.applySigmoid). You can add additional methods if needed.  You will also need to complete the SVM and SOFTMAX loss functions for the forward pass.

You can verify that your forward pass code is working by using PA21Tests.java
