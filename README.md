...
Transformer Architectures (Encoders, Decoders, Attention)
...
Programming assignments will be done in the Java programming language, and the student's term project will be done in Python using a modern neural network framework. Assignments will be submitted by Git using GitHub.
...
The course grade will consist of three programming assignments (each with three or fourparts), and a project using a neural network framework.
